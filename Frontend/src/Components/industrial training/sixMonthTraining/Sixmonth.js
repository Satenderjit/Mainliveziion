    ...
    <>
      ...
      <div className={styles.sixMonthHeroWrapper}>
        ...
        <div className={styles.sixMonthHeroContainer}>
          ...
          <div className={styles.sixMonthHeroContent}>
            <p className={styles.sixMonthHeroWelcome}>
              Welcome to Ziion Technology
            </p>
            <h1 className={styles.sixMonthHeroTitle}>
              Six Weeks{" "}
              <span className={styles.sixMonthHeroHighlight}>
                Industrial Training
              </span>{" "}
              <br />
            ...
            <button
              className={styles.sixMonthHeroBtn}
      ...
      <section className={styles.container}>
        <div className={styles.left}>
          <h2 className={styles.title}>
            How to Enroll in Six Months Industrial Training in{" "}
            <span>Chandigarh & Mohali?</span>
          </h2>
          <p className={styles.subtitle}>
            Join our 6 weeks industrial training in Chandigarh or Mohali with
            these simple steps, perfect for summer training for CSE students.
          </p>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.highlight}>
              ...
              We partner with top companies to ensure our curriculum meets
              industry needs.
            </p>
          </div>
        </div>
      ...
      <section className={styles.joinSection}>
        ...
        <p className={styles.subtext}>
          Master in-demand skills designed for students andn profesionals from
        ...
        <div className={styles.infoBox}>
          ...
          <div className={styles.contactItem}>
            ...
            <div>
              <h5>Visit Us</h5>
              <p>
                Building No. D152, 1st Floor, Phase 8, Industrial Area, Mohali
              </p>
            </div>
          </div>
