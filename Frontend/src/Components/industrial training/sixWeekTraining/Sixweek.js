      ...
      <section className={styles.coursesHeroContainer}>
        ...
        {floatingImages.map((img, i) => (
          <img
            ...
            src={img}
            alt={`Course ${i + 1}`}
            className={`${styles.coursesFloatingImage} ${
              styles["coursesPos" + (i + 1)]
            }`}
          />
        ))}
        ...
        <div className={styles.coursesHeroContent}>
          ...
          <p className={styles.coursesHeroSub}>
            Build hands-on skills with real projects, guided by industry
            experts.
          </p>

          <button
            className={styles.coursesHeroBtn}
          ...
          {/* Course Title */}
          <h3 className={styles.coursesHeroCourse}>
